...
class _HomeContentState extends State<HomeContent>
  ...
  // ── Parse raw API list — now keeps all fields needed for dialogs ──────
  ...
  void _showOrderConfirmationDialog(
    ...
    showDialog(
      ...
      builder: (_) => _OrderConfirmationDialog(
        ...
        onPostOrder: () {
          Navigator.pop(context);
          // TODO: call your order posting API here
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 6),
                const Text('\$180.00',
                    style: TextStyle(color: _green, fontSize: 36,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: _green.withOpacity(0.4), blurRadius: 10, offset: const Offset(0, 4))],
                  ),
                  child: const Row(children: [
                    Icon(Icons.add_rounded, color: Colors.white, size: 16),
                    SizedBox(width: 5),
                    Text('Top Up', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w800)),
                  ]),
                ),
              ),
            ],
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.tag_rounded, color: _gold.withOpacity(0.8), size: 13),
                const SizedBox(width: 6),
                Text('Account: $_userCds',
                    style: TextStyle(color: Colors.white.withOpacity(0.5),
                        fontSize: 12, fontWeight: FontWeight.w500)),
                const SizedBox(width: 10),
                Container(width: 1, height: 12, color: Colors.white.withOpacity(0.12)),
                const SizedBox(width: 10),
                Icon(Icons.copy_rounded, color: Colors.white.withOpacity(0.3), size: 12),
              ],
            ),
          ),
        ],
  ...
  Widget _buildSunIcon() {
    return TweenAnimationBuilder<double>(
      ...
      child: Container(
        width: 58, height: 58,
        decoration: BoxDecoration(
          gradient: const RadialGradient(colors: [Color(0xFFFFE066), Color(0xFFFFAA00)]),
          shape: BoxShape.circle,
          boxShadow: [BoxShadow(color: const Color(0xFFFFAA00).withOpacity(0.5), blurRadius: 20, spreadRadius: 3)],
        ),
  ...
  Widget _buildQuickStats() {
    return Row(children: [
      Expanded(child: _statCard(icon: Icons.trending_up_rounded, label: "Today's Gain", value: '+\$24.50', valueColor: _green, iconBg: _green)),
      const SizedBox(width: 12),
      Expanded(child: _statCard(icon: Icons.swap_horiz_rounded, label: 'Open Orders', value: '3', valueColor: _gold, iconBg: _gold)),
      const SizedBox(width: 12),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(width: 32, height: 32,
            decoration: BoxDecoration(color: iconBg.withOpacity(0.12), borderRadius: BorderRadius.circular(9)),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            gradient: isSelected ? const LinearGradient(colors: [_green, _darkGreen]) : null,
            color: isSelected ? null : Colors.transparent,
            borderRadius: BorderRadius.circular(14),
            boxShadow: isSelected ? [BoxShadow(color: _green.withOpacity(0.35), blurRadius: 10, offset: const Offset(0, 4))] : [],
          ),
          child: Text(label, textAlign: TextAlign.center,
              style: TextStyle(color: isSelected ? Colors.white : const Color(0xFF888888),
                  fontSize: 13, fontWeight: isSelected ? FontWeight.w800 : FontWeight.w500, letterSpacing: 0.2)),
        ),
      ),
    );
  }
      ...
      children: [
        Row(children: [
          Container(width: 4, height: 18,
              decoration: BoxDecoration(
                  gradient: const LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [_green, _darkGreen]),
                  borderRadius: BorderRadius.circular(2))),
          const SizedBox(width: 10),
          Text(_isPrimaryMarket ? 'Primary Market' : 'Secondary Market',
              style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: _dark, letterSpacing: 0.2)),
        ]),
        if (!_isLoadingCurrent)
  ...
  Widget _buildCommodityCard(Map<String, dynamic> commodity, int index) {
    ...
    return TweenAnimationBuilder<double>(
      ...
      child: GestureDetector(
        onTap: () => _showProductDetailsDialog(commodity), // ← opens Dialog 1
        child: Container(
          ...
          child: Row(children: [
            Container(
              width: 44, height: 44,
              decoration: BoxDecoration(
                  color: isPositive ? _green.withOpacity(0.1) : const Color(0xFFE53935).withOpacity(0.1),
                  borderRadius: BorderRadius.circular(13)),
              child: Icon(Icons.grass_rounded,
                  color: isPositive ? _green : const Color(0xFFE53935), size: 22),
            ),
            const SizedBox(width: 12),
            Expanded(
              flex: 3,
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: _gold.withOpacity(0.1), borderRadius: BorderRadius.circular(5)),
                    child: Text(commodity['currency'],
                        style: const TextStyle(fontSize: 9, color: _gold, fontWeight: FontWeight.w700)),
                  ),
            ...
            Expanded(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Text(commodity['bid'], style: const TextStyle(fontSize: 12, color: _dark, fontWeight: FontWeight.w700)),
                ]),
                const SizedBox(height: 4),
                Row(children: [
                  Text('Ask  ', style: TextStyle(fontSize: 10, color: Colors.grey.shade400, fontWeight: FontWeight.w500)),
                  Text(commodity['ask'], style: const TextStyle(fontSize: 12, color: _gold, fontWeight: FontWeight.w700)),
                ]),
              ]),
            ),
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(13),
                boxShadow: [BoxShadow(color: (isPositive ? _green : const Color(0xFFE53935)).withOpacity(0.3),
          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(colors: [Color(0xFF1A1A1A), Color(0xFF2C2C2C)]),
              ...
              child: Row(children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.close_rounded, color: _gold, size: 18),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(colors: [Color(0xFFD4A017), Color(0xFFB8860B)]),
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [BoxShadow(color: _gold.withOpacity(0.4), blurRadius: 10, offset: const Offset(0, 4))],
                      ),
                      child: const Center(child: Text('BUY', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w900, letterSpacing: 1.5))),
                    ),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 15),
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(colors: [_green, Color(0xFF1E8E32)]),
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [BoxShadow(color: _green.withOpacity(0.4), blurRadius: 10, offset: const Offset(0, 4))],
                      ),
                      child: const Center(child: Text('SELL', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w900, letterSpacing: 1.5))),
                    ),
                  ),
                ),
              ]),
...
class _BuySellFormDialogState extends State<_BuySellFormDialog> {
  ...
  void _submit() {
    ...
    if (_selectedCategory == null || qty == null || price == null || qty <= 0 || price <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(btnLabel,
                  style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Color(0xFF1A1A1A), letterSpacing: 1)),
            ),
            ...
            _styledField(
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  isExpanded: true,
                  hint: const Text('Category', style: TextStyle(color: Colors.grey, fontSize: 14)),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  boxShadow: [BoxShadow(color: btnColor.withOpacity(0.4), blurRadius: 12, offset: const Offset(0, 5))],
                ),
                child: Center(
                  child: Text(btnLabel,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text('You are posting a ${isBuy ? 'buy' : 'sell'} order for the following commodity:',
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Total', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: Color(0xFF1A1A1A))),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Center(child: Text('Post Order',
  ...
  Widget _confRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF1A1A1A))),
          Text(value,  style: TextStyle(fontSize: 13, color: Colors.grey.shade600, fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
